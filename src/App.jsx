...
const questionsData = [
  ...
  { 
    q: "Trong Di chúc, Hồ Chí Minh đã căn dặn điều gì về đạo đức của Đảng ta?", 
    opts: ["Phải đoàn kết chặt chẽ trong nội bộ", "Phải giữ gìn Đảng ta thật trong sạch, phải xứng đáng là người lãnh đạo, người đày tớ thật trung thành của nhân dân", "Phải đẩy mạnh sản xuất và tiết kiệm", "Phải mở rộng dân chủ trong sinh hoạt Đảng"], 
    ans: 1, part: "PHẦN 1: TƯ TƯỞNG HỒ CHÍ MINH" 
  },
  { 
    q: "Theo Hồ Chí Minh, tự phê bình và phê bình có vai trò như thế nào trong tổ chức Đảng?", 
    opts: ["Là biện pháp để kỷ luật đảng viên vi phạm", "Là hình thức để đánh giá thi đua khen thưởng", "Là vũ khí sắc bén nhất để đánh thắng kẻ thù", "Là 'thang thuốc' tốt nhất, là việc làm thường xuyên 'như mỗi ngày phải rửa mặt'"], 
    ans: 3, part: "PHẦN 1: TƯ TƯỞNG HỒ CHÍ MINH" 
  },
  { 
    q: "Hồ Chí Minh cảnh báo điều gì sẽ xảy ra nếu Đảng không đạo đức, văn minh?", 
    opts: ["Sẽ bị mất quyền lãnh đạo, đội ngũ cán bộ thoái hoá, biến chất", "Sẽ phát triển chậm lại so với các nước", "Sẽ mất đi sự ủng hộ của phong trào quốc tế", "Sẽ thiếu hụt nguồn lực xây dựng đất nước"], 
    ans: 0, part: "PHẦN 1: TƯ TƯỞNG HỒ CHÍ MINH" 
  },
  { 
    q: "Cán bộ, đảng viên phải có mối liên hệ mật thiết với nhân dân, tuân thủ phương châm, thái độ nào?", 
    opts: ["Luôn học tập nâng cao trình độ về mọi mặt", "Tôn trọng và phát huy quyền làm chủ của nhân dân", "Đảng viên đi trước, làng nước theo sau", "Tất cả các ý trên"], 
    ans: 3, part: "PHẦN 1: TƯ TƯỞNG HỒ CHÍ MINH" 
  },
  { 
    q: "Tác phẩm nào của Hồ Chí Minh nêu lên '12 điều' về tư cách của đảng chân chính cách mạng, trong đó có yêu cầu 'Đảng phải luôn luôn xét lại những nghị quyết và những chỉ thị của mình'?", 
    opts: ["Bản án chế độ thực dân Pháp", "Đường Kách mệnh", "Sửa đổi lối làm việc", "Di chúc"], 
    ans: 2, part: "PHẦN 1: TƯ TƯỞNG HỒ CHÍ MINH" 
  },
  ...
  { 
    q: "Để siết chặt kỷ luật, Đại hội XIV yêu cầu xử lý nghiêm các hiện tượng tiêu cực nào trong đội ngũ?", 
    opts: ["Thiếu bằng cấp chuyên môn", "Đi làm trễ giờ", "Đùn đẩy, né tránh, sợ trách nhiệm, 'chạy chức, chạy quyền'", "Phát biểu sai quan điểm cá nhân"], 
    ans: 2, part: "PHẦN 2: TINH THẦN ĐẠI HỘI XIV" 
  },
  { 
    q: "Theo Đại hội XIV, phương châm hành động mới để khắc phục triệt để tình trạng 'nói nhiều làm ít', 'nói không đi đôi với làm' là gì?", 
    opts: ["Tăng cường họp bàn và ra nghị quyết", "Giao toàn quyền cho chuyên gia tư vấn", "Đẩy mạnh phê bình cá nhân trên báo chí", "Phân công rõ người, rõ việc, nói đi đôi với làm, làm đến nơi đến chốn, đo lường bằng kết quả"], 
    ans: 3, part: "PHẦN 2: TINH THẦN ĐẠI HỘI XIV" 
  },
  { 
    q: "Đổi mới công tác cán bộ theo chủ trương của Đại hội XIV yêu cầu thực hiện cơ chế linh hoạt nào?", 
    opts: ["'Vào dễ, ra khó'", "'Có vào, có ra', 'có lên, có xuống'", "Ưu tiên thâm niên lên làm lãnh đạo", "Luân chuyển cán bộ liên tục không cần đánh giá"], 
    ans: 1, part: "PHẦN 2: TINH THẦN ĐẠI HỘI XIV" 
  },
  { 
    q: "Theo Đại hội XIV, công tác kiểm tra, giám sát của Đảng cần chuyển trọng tâm thay đổi từ bị động sang trạng thái nào?", 
    opts: ["Chuyển cho cơ quan nhà nước thực hiện", "Tập trung xử lý kỷ luật thật nặng", "Chủ động, kiểm tra từ sớm, từ xa, ngay từ chi bộ để phòng ngừa, cảnh báo vi phạm", "Chỉ kiểm tra khi có đơn tố cáo"], 
    ans: 2, part: "PHẦN 2: TINH THẦN ĐẠI HỘI XIV" 
  },
  { 
    q: "Đại hội XIV nhấn mạnh mối quan hệ giữa kỷ luật Đảng và pháp luật Nhà nước như thế nào trong xử lý vi phạm?", 
    opts: ["Xử lý hành chính trước, kỷ luật Đảng sau", "Kỷ luật của Đảng phải đi trước; kỷ cương phép nước phải nghiêm", "Phải có ngoại lệ đối với cán bộ có công lớn", "Xử lý nội bộ để giữ uy tín cho tổ chức"], 
    ans: 1, part: "PHẦN 2: TINH THẦN ĐẠI HỘI XIV" 
  }
];
...
function App() {
  ...
  const nextQuestion = () => {
    if (currentQuestion < questionsData.length - 1) {
      ...
      alert("Đã hoàn thành bộ 30 câu hỏi!");
    }
  };
  ...
  return (
    <>
      <header>
        <h1>★ HỘI THI TÌM HIỂU ĐẠO ĐỨC CÁCH MẠNG ★</h1>
